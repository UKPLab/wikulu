...
/**
 * This interface represent backlink extractor.
 * @author Fabian L. Tamin
 *
 */
public interface BacklinkExtractor {
	/**
	 * Gets the list of extracted backlinks.
	 * @return the list of extracted backlinks.
	 */
