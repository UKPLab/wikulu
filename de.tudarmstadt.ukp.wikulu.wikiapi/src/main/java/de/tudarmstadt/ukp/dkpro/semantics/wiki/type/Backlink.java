...
public class Backlink extends Link {
   ...
   * @ordered 
   */
  public final static int typeIndexID = JCasRegistry.register(Backlink.class);
  /** @generated
   * @ordered 
   */
   ...
   * @generated */
  public Backlink(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  
  /** @generated */
  public Backlink(JCas jcas) {
    super(jcas);
    readObject();   
  } 

  /** @generated */  
  public Backlink(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
