...
// Wikipedia
//var mainURL = "http://en.wikipedia.org";
//var viewURL = "http://en.wikipedia.org/wiki/";
...
//var viewURL = "http://mrburns.tk.informatik.tu-darmstadt.de/wikipedia_en/index.php";
//var apiURL = "http://mrburns.tk.informatik.tu-darmstadt.de/wikipedia_en/api.php";
//var wikiSyntax = "MediaWiki";
//var keyphraseURL = "http://mrburns.tk.informatik.tu-darmstadt.de/wikipedia_en/index.php?title=Special%3ASearch&redirs=1&fulltext=Search&ns0=1&search=";
//var monitorNode = "";
//var monitorPath = "/wikipedia_en/";
//var titleNode = "#firstHeading";
//!----------------------------------!


//!-------- WikuluVM(TWiki)-------!
var mainURL = "http://wikulu.tk.informatik.tu-darmstadt.de";
var viewURL = "http://wikulu.tk.informatik.tu-darmstadt.de/twiki/bin/view";
var apiURL = "http://wikulu.tk.informatik.tu-darmstadt.de/twiki/bin/rest/WikuluPlugin/";
...
//var viewURL = "http://localhost/twiki/bin/view";
//var apiURL = "http://localhost/twiki/bin/rest/WikuluPlugin/";
//var wikiSyntax = "TWiki";
//var keyphraseURL = "http://www.cs.wisc.edu/twiki/bin/view/TWiki/TagMeSearch?tag=";
//var monitorNode = "#patternMainContents";
//var monitorPath = "/twiki/bin/view/";
...
//!-------- Wikipedia (MediaWiki)-------!
//var mainURL = "http://en.wikipedia.org/wiki/";
//var apiURL = "http://en.wikipedia.org/w/api.php";
//var wikiSyntax = "MediaWiki";
//var keyphraseURL = "http://en.wikipedia.org/w/index.php?title=Special%3ASearch&redirs=1&fulltext=Search&ns0=1&search=";
//var monitorNode = "";
...
//var wikiSyntax = "MediaWiki";
//var keyphraseURL = "http://wiki.bildungsserver.de/index.php?title=Special%3ASearch&redirs=1&fulltext=Search&ns0=1&search=";
//var monitorNode = "";
...
$(document).ready(function() {
	...
	if (location.href.indexOf(mainURL, 0) > -1 || directProxy == "yes" ) {
		detectMousePosition();
...
function Sniffer(parentSnifferSdNodes) {
	...
	this.executeAppendToWindow = function() {
		...
		var targetLink ;
		if(port == ""){
			targetLink = new String(location.protocol+"//"+document.domain+this.hrefNode.attr("href"));
		}else{
			targetLink = new String(location.protocol+"//"+document.domain+":"+port+this.hrefNode.attr("href"));
		}
			
		
		//var targetLink = new String(location.protocol+"//mrburns.tk.informatik.tu-darmstadt.de"+this.hrefNode.attr("href"));
	...
	this.addSniffer = function() {
		...
		snifferHTML += "		<div class=\"ws_loading\"><div class=\"ws_loading_img\"></\div><div class=\"ws_loading_text\">Wiki-Sniffer: <b>loading contents<\/b>...<\/div><\/div>";
